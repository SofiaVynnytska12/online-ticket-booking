...
import duikt.practice.otb.exception.*;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(BookedTicketException.class)
    public ResponseEntity<ErrorResponse> handleBookedTicketException(
            HttpServletRequest request, BookedTicketException ex) {
        return getErrorResponse(request, HttpStatus.FORBIDDEN, ex.getMessage());
    }
    ...
    public ResponseEntity<ErrorResponse> handleInvalidDataException(
            HttpServletRequest request, InvalidDataException ex) {
