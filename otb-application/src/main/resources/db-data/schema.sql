...
CREATE TABLE train_tickets (
                               ...
                               type_of_train_class VARCHAR(255) CHECK(type_of_train_class IN ('FIRST_CLASS', 'SECOND_CLASS', 'LUXURY')),
...
ALTER TABLE train_tickets DROP FOREIGN KEY owner_id_train_tickets_fk;
ALTER TABLE bus_tickets DROP FOREIGN KEY owner_id_bus_tickets_fk;
